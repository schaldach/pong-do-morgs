...
function setup(){
    ...
    warning1 = createDiv('PC: Use o Mouse<br/>Mobile: Use o toque<br/><br/>')
    ...
    warning2 = createDiv('PC:<br/> Jogador 1 - W e S<br/>Jogador 2 - ↑ e ↓<br/>Mobile:<br/> Cada um controla <br/>seu lado com o toque<br/><br/>')
